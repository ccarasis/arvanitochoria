var config = {
    ...
    byline: byline: '<img src="./assets/IMG_3358.jpg" style="width:100%; border-radius:6px; margin:15px 0;"><br>'By Christina Maria Carasis <br> University of California, Berkeley <br> Department of Geography',
